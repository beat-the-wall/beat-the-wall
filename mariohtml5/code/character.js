...
Mario.Character.prototype.Move = function() {
  ...
  var sideWaysSpeed = (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Shift) ) ? 1.2 : 0.6;
  ...
  if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Up)) || (this.JumpTime < 0 && !this.OnGround && !this.Sliding)) {
    if (this.JumpTime < 0) {
  ...
  if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Shift) ) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
  ...
  this.CanShoot = !(Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Shift) );
  this.MayJump = (this.OnGround || this.Sliding) && !(Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Up));
  ...
  if (this.Carried !== null) {
    ...
    if (!(Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Shift) )) {
...
Mario.Character.prototype.Stomp = function(object) {
  ...
  if (object instanceof Mario.Enemy || object instanceof Mario.BulletBill) {
    ...
    if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Shift) ) && object.Facing === 0) {
      this.Carried = object;
      object.Carried = true;
    } else {
      Enjine.Resources.PlaySound("kick");
